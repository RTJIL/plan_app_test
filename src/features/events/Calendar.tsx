...
export default function Calendar() {
  ...
  const [importanceFilter, setImportanceFilter] = useState<Importance>("low");
  ...
  return (
    <div className="p-4">
      <div className="flex justify-between items-center mb-4">
        ...
        />
        <h3
          className="cursor-pointer hover:underline underline-offset-4 text-red-600/100"
